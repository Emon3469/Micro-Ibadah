...
export default function Landing() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-4">
      <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-3xl bg-linear-to-br from-primary/25 via-base-100 to-secondary/20 ring-4 ring-primary/20 shadow-lg">
        <img src={projectLogo} alt="Micro-Ibadah logo" className="h-16 w-16 object-contain" />
      </div>
