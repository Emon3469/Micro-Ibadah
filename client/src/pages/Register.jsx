    ...
    <div className="flex justify-center items-center min-h-[80vh] py-8">
      <Card className="w-full max-w-md shadow-xl border-primary/20">
        <CardHeader className="text-center pb-2">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-primary/20 via-base-100 to-secondary/15 ring-2 ring-primary/20 shadow-sm">
            <img src={projectLogo} alt="Micro-Ibadah logo" className="h-10 w-10 object-contain" />
          </div>
